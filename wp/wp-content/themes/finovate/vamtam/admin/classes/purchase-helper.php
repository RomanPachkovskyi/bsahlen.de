	...
	public static function import_buttons() {
		...
		$import_tests = array(
			array(
				...
				'failed' => wp_kses( __( "This theme requires Elementor Pro. If you don't have Elementor Pro, please <a href='https://be.elementor.com/visit/?bta=13981&nci={$el_pro_nci}' target='_blank'>download it here</a>. Install and activate it, and then proceed with importing the demo content. If you have any issues with the importer please <a href='https://elementor.support.vamtam.com/support/solutions/articles/245218-vamtam-elementor-themes-how-to-install-the-theme-via-the-admin-panel-' target='_blank'>read this article</a> or reach out to us using <a href='https://vamtam.com/contact-us/' target='_blank'>the form on this page</a>.", 'finovate' ), 'vamtam-a-span' ),
			),
		);
		...
		$buttons = array(
			array(
				...
				'button_title'   => $content_imported ? esc_html__( 'Imported', 'finovate' ) : esc_html__( 'Import', 'finovate' ),
